...
#set.seed( 1234 )
#d2 <- select( df, MHV.Growth.00.to.12, Vacant.growth, Unemp.growth, #Income.growth, na.rm = TRUE )

# recode some vars to remove outliers and skew
#d2$MHV.Growth.00.to.12[ d2$MHV.Growth.00.to.12 > 200 ] <- NA
#d4 <- sample_n( d2, 500,na.rm = TRUE ) %>% 
