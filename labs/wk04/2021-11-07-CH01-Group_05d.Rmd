...
The results were that two of our three variables ended up being pretty good predictors of neighborhood change.  Income was the most important followed by unemployment.  We assumed that increased vacancy would drop the median home value due to less people occupying homes, thereby decrease the average price.  However, vacancy did not have a substantial impact on median home value indicating that we would have to do more research to determine why vacancy does not have an impact.
