...
```{r}
#Correlation check
measurement.1 <- select(df, Vacant.change, Income.change, Unemp.change) %>% na.omit ()
...
par( mfrow=c(1,2) )
hist( df$Vacant.change, breaks= 150, col="gray20", border="white",
...
set.seed( 1234 )
d2 <- select( df, MHV.Growth.00.to.12, Vacant.growth, Unemp.growth, Income.growth )
