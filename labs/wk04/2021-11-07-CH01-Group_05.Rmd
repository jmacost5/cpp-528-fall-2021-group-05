...
```{r}
#Variable Exploration: create subset to visualize in correlation matrix

d2 <- select(d, mhv.growth, p.vacant, hinc00, h30old00, p.unemp, p.prof00, p.col, p.rent) #pov.rate, p.unemp)
...
```{r}
#Professional Employee and Household Income

prof.00 <- d$p.prof00
prof.10 <- d$p.prof10
prof.change <- prof.10 - prof.00
p.prof.change <- prof.change/prof.00
p.prof.growth <- log10(p.prof.change +1)
d$prof.change <- prof.change
d$prof.growth <- p.prof.growth
...
cor( hinc.00, prof.00, use="pairwise.complete" )
log.p.hinc.00 <- log10( hinc.00 + 1 )
log.p.prof.00 <- log10( prof.00 + 1 )
cor( log.p.hinc.00, log.p.prof.00, use="pairwise.complete" )
...
#% Unemployed and % Renting

rent.00 <- d$p.rent
rent.10 <- d$p.rent10
rent.change <- rent.10 - rent.00
p.rent.change <- rent.change/rent.00
p.rent.growth <- log10(p.rent.change +1)

d$rent.change <- p.rent.change
d$rent.growth <- p.rent.growth
...
cor( rent.00, unemp.00, use="pairwise.complete" )
log.p.rent <- log10( rent.00 + 1 )
log.p.unemp <- log10( unemp.00 + 1 )
cor( log.p.rent, log.p.unemp, use="pairwise.complete" )
...
p.vacant.change <- (vacant.10 - vacant.00)/vacant.00
...
df <- data.frame( MedianHomeValue2000=mhv.00, 
                  ...
                  Rent2000 = rent.00,
                  Rent2010 = rent.10,
                  Rent.change = p.rent.change,
                  Rent.growth = p.rent.growth,
                  Income2000 = hinc.00,
                  Income2010 = hinc.10,
                  ...
                  Prof2000 = prof.00,
                  Prof2010 = prof.10,
                  Prof.change = p.prof.change,
                  Prof.growth = p.prof.growth)
...
```{r}
#Household Income and Professional Employee Change
measurement.1 <- select(df, Prof.growth, Income.growth) %>% na.omit ()

measurement.2 <- select(df, Rent.growth, Unemp.growth) %>% na.omit()

measurement.3 <- df$Vacancyrate %>% na.omit()
```
...
```{r}
par( mfrow=c(2,2) )
hist( df$Prof2000, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Professional Employees 2000",)
hist( log(df$Prof2000+1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Professional Employees 2000 (logged)")
hist( df$Prof2010, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Professional Employees 2010",)
hist( log(df$Prof2010+1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Professional Employees 2010 (logged)")
```

```{r}
par( mfrow=c(1,2) )
hist( df$Prof.change, breaks= 150, col="gray20", border="white", xlim=c(-100,250),
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Professional Employees Change 2000 to 2010",)
hist( log(df$Prof.change + 1), breaks=150, col="gray20", border="white",xlim=c(-2,2),
...
```{r}
par( mfrow=c(2,2) )
hist( df$Rent2000, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Rental Homes 2000",)
hist( log(df$Rent2000+1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Rental Homes 2000 (logged)")
hist( df$Rent2010, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Rental Homes 2010",)
hist( log(df$Rent2010 +1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Rental Homes 2010 (logged)")
```
...
par( mfrow=c(1,2) )
hist( df$Rent.change, breaks= 150, col="gray20", border="white", xlim=c(-100,250),
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Rental Homes from 2000 to 2010",)
hist( log(df$Rent.change + 1), breaks=150, col="gray20", border="white",xlim=c(-2,2),
      yaxt="n", xlab="", ylab="", main="Percent of Rental Homes from 2000 to 2010(logged)")
```
...
hist( df$Vacant2000, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Vacancy 2000",)
hist( log(df$Vacant2000+1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Vacancy 2000 (logged)")
hist( df$Vacant2010, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Vacancy 2010",)
...
par( mfrow=c(1,2) )
hist( df$Vacancyrate, breaks= 150, col="gray20", border="white",
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Vacancy from 2000 to 2010",)
hist( log(df$Vacancyrate + 1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Vacancy from 2000 to 2010(logged)")
...
hist( df$Unemp2000, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Unemployment 2000",)
...
hist( df$Unemp2010, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Unemployment 2010",)
...
par( mfrow=c(1,2) )
hist( df$Unemp.change, breaks= 150, col="gray20", border="white",
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Unemployment Change from 2000 to 2010",)
hist( log(df$Unemp.change + 1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Unemployment Change from 2000 to 2010(logged)")
```
...
hist( df$Income2000, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Household Income 2000",)
hist( log(df$Income2000 +1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Household Income 2000 (logged)")
hist( df$Income2010, breaks=150, col="gray20", border="white", 
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Household Income 2010",)
hist( log(df$Income2010 +1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Household Income 2010 (logged)")
```
...
par( mfrow=c(1,2) )
hist( df$Income.change, breaks= 150, col="gray20", border="white",
      yaxt="n", xlab="xlabel", ylab="", main="Percent of Household Income Change from 2000 to 2010",)
hist( log(df$Income.change + 1), breaks=150, col="gray20", border="white",
      yaxt="n", xlab="", ylab="", main="Percent of Household Income Change from 2000 to 2010(logged)")
```


**Unemployee and Rental Homes**


```{r}
#these <- sample(1:length(df$Unemp.growth), 5000)
#par(mfrow = c(1,2))
#jplot(df$Unemp2000[these], df$Rent.2000[these],
#      lab1 = "Unemployed 2000", lab2 = "Rental Homes 2000 (percent)",
#      main = "Raw Measures")
#jplot(df$Unemp.growth[these], df$Rent.growth[these],
#      lab1 = "Unemployed Growth (logged)", lab2 = "Rental Homes (percent)",
...
set.seed( 1234 )
d2 <- select( df, MHV.Growth.00.to.12, Vacancyrate, Prof.growth, Unemp.growth, Rent.growth, Income.growth )
# recode some vars to remove outliers and skew
d2$MHV.Growth.00.to.12[ d2$MHV.Growth.00.to.12 > 200 ] <- NA
...
reg.data$p.rent <- log10( reg.data$p.rent + 1 )
m1 <- lm( mhv.growth ~  p.rent, data=reg.data )
m2 <- lm( mhv.growth ~  p.unemp, data=reg.data )
m3 <- lm(mhv.growth ~ p.vacant, data = reg.data)
m4 <- lm( mhv.growth ~  p.rent + p.unemp + p.vacant, data=reg.data )
